...
password = 'test'
cxn_str = f'mongodb+srv://test:{password}@cluster0.npxoeyd.mongodb.net/?retryWrites=true&w=majority'
...
def delete_ex():
    ...
    return jsonify({'result': 'success', 'msg': f'Your sentence for the word, {word}, was deleted',})
